...
const swisseph_api_generated_js_1 = require("../generated/swisseph_api.generated.js");
Object.defineProperty(exports, "Constants", { enumerable: true, get: function () { return swisseph_api_generated_js_1.Constants; } });
/**
...
async function load(options = {}) {
    ...
    if (wasmSource instanceof Uint8Array) {
        ...
        const url = wasmSource ||
            new URL("../generated/libswephe.wasm", globalThis[Symbol.for("import-meta-ponyfill-commonjs")](require, module).url);
        if (typeof dntShim.Deno !== "undefined") {
            bytes = await dntShim.Deno.readFile(url instanceof URL ? url : new URL(url, globalThis[Symbol.for("import-meta-ponyfill-commonjs")](require, module).url));
        }
        else {
