...
export async function load(options = {}) {
    ...
    if (wasmSource instanceof Uint8Array) {
        ...
        const url = wasmSource ||
            new URL("../generated/libswephe.wasm", globalThis[Symbol.for("import-meta-ponyfill-esmodule")](import.meta).url);
        if (typeof dntShim.Deno !== "undefined") {
            bytes = await dntShim.Deno.readFile(url instanceof URL ? url : new URL(url, globalThis[Symbol.for("import-meta-ponyfill-esmodule")](import.meta).url));
        }
        else {
